...
class EditEntry extends Component {
  constructor(props) {
    ...
    if (props.location.state) {
      const { id, name, rating, visitCount, price, type, cities, isClosed } = props.location.state.foodObj
  ...
  handleSubmit = async (e) => {
    const { id, name, cities, type, rating, price, visitCount, isClosed } = this.state
    e.preventDefault()
  ...
  handleDelete = async (e) => {
    ...
    await this.props.deleteFood(this.state.id)
        ...
        <div className='home-container container'>
          <div className='row vert-align'>
            <div className='col-12'>
              <h1>MUST BE AN ADMIN TO EDIT ENTRIES.</h1>
            </div>
          </div>
        </div>
      )
              ...
              <div className='modal-content'>
                ...
                <div className='modal-body'>
                  <form id='modal-form' onSubmit={(e) => this.handleSubmit(e)}>
                    ...
                    <div>
                      <button className='btn btn-danger btn-block btn-lg' onClick={(e) => this.handleDelete(e)}>
                        Delete
                      </button>
                    </div>
                  </form>
